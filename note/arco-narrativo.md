...
L'arco emotivo tra i due protagonisti attraversa **tutto il libro** — ma Laura **non deve emergere in fretta**. Resta oscura, nascosta, presente come ombra prima che come persona.

| Fase | Rapporto | Note |
|------|----------|------|
| **Inizio** | Assenza / presenza fantasma | Sguardo nell'Etere, messaggi anonimi, sensazione di essere osservato. **Niente nome, niente faccia.** |
| **Centro** | Conflitto | Quando finalmente si incontrano davvero: visioni opposte, ruolo di Luca in Prisma |
| **Fine** | Complicità → amore | Costruito pagina dopo pagina, senza fretta |

### Ritmo della rivelazione

- **Cap. 1**: una figura nell'Etere. Punto.
...
| Cap. 5 | **Blackout** settore Nord-Est; comunicato Eos = guasto risolto | In realtà: operazione per **Erebo** |
