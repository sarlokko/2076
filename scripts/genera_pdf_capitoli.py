...
CAPITOLI = [ROOT / "capitoli" / "01.md", ROOT / "capitoli" / "02.md"]
OUTPUT = ROOT / "capitoli" / "2076-capitoli-01-02.pdf"
...
def main() -> None:
    ...
    pdf.cell(0, 8, "Capitoli 1 e 2", align="C", new_x="LMARGIN", new_y="NEXT")
