...
CAPITOLI = [ROOT / "capitoli" / f"{i:02d}.md" for i in range(1, 13)]
OUTPUT = ROOT / "capitoli" / "2076-capitoli-01-12.pdf"
...
def main() -> None:
    ...
    pdf.cell(0, 8, "Capitoli 1–12", align="C", new_x="LMARGIN", new_y="NEXT")
